...
function love.load()
    ...
    menuFont = love.graphics.newFont('font.ttf', 4)
...
--     if button == 'l' then
--         love.graphics.setFont(smallFont)
--         love.graphics.printf(tostring(buttons.single_player.x), 0, 10, VIRTUAL_WIDTH, 'center')
--         love.graphics.printf(tostring(buttons.single_player.y), 0, 10, VIRTUAL_WIDTH + 40, 'center')
--         if x <= buttons.single_player.x + 56 and x > buttons.single_player.x and y < buttons.single_player.y + 29 and y > buttons.single_player.y then
--             gameState = 'start'
--         end
--     end
-- end
...
function displayPos()
    -- score display
    love.graphics.setFont(scoreFont)
    love.graphics.print(tostring(currentX), VIRTUAL_WIDTH / 2 - 50,
        VIRTUAL_HEIGHT / 3)
    love.graphics.print(tostring(currentY), VIRTUAL_WIDTH / 2 + 30,
        VIRTUAL_HEIGHT / 3)
end
